...
public class Pacotinho {
    ...
    public Colecionavel[] getFigurinhas() {
        List <Colecionavel> todaAsFigurinhas = repo.getTodasAsFigurinhas();
        List <Colecionavel> figurinhasDoPacotinho = new ArrayList<Colecionavel>();
        ...
        return (Colecionavel[]) figurinhasDoPacotinho.toArray(new Colecionavel[quantFigurinhas]);
    }
