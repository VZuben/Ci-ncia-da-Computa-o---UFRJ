...
public class AlbumTest {
    ...
    public void setUp() {
        this.repositorioFigurinhas = new Repositorio<>("album_copa2014", TAMANHO_DO_ALBUM, Figurinha.class);
        this.albumFigurinhas = new Album<>(repositorioFigurinhas, ITENS_POR_PACOTE);
        this.repositorioSelos = new Repositorio<>("album_selosRaros2014", TAMANHO_DO_ALBUM, Selo.class);
    ...
    //Criei esse teste para questão 6.
    @Test
    public void testarAlbunsDiferentes() {
        popularAlbum(new int[] {1, 2, 3, 4, 5, 6, 7, 8, 8, 8, 8});

        Pacotinho pacoteFigurinhas = new Pacotinho(this.repositorioFigurinhas, new int[] {1, 2, 3});
