...
// Todos os seus métodos podem indicar se a thread que está lendo ou escrevendo
// é uma thread leitora/escritora, imprimindo na saída padrão
class LE {
...
public class Lab8 {
    ...
    public static void main (String[] args) {
      ...
      //se escrevermos "corretudePy" como argumento na hora de compilar, a impressão do log do programa vai ser .py 
